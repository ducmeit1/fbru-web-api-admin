...
(function() {
        ...
        q = new CKEDITOR.htmlParser.filter({
            ...
            elements: {
                a: function(e) {
                    ...
                    e.attributes.name &&
                        w[e.attributes.name] &&
                        (e = w[e.attributes.name], e.attributes.href = e.attributes.href.replace(/.*#(.*)$/, "#$1"));
                },
                div: function(e) { k.createStyleStack(e, q, b) },
                img: function(e) {
                    ...
                    k.mapStyles(e,
                        {
                            width: function(a) { k.setStyle(e, "width", a + "px") },
                            height: function(a) { k.setStyle(e, "height", a + "px") }
                        });
                    e.attributes.src &&
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        normalizedStyles: function(a, b) {
            var c =
                    "background-color:transparent border-image:none color:windowtext direction:ltr mso- text-indent visibility:visible div:border:none"
                        .split(" "),
            ...
            "cke:li" == a.name &&
                h["TEXT-INDENT"] &&
                h.MARGIN &&
                (a.attributes["cke-indentation"] = g.getElementIndentation(a), h.MARGIN =
                    h.MARGIN.replace(/(([\w\.]+ ){3,3})[\d\.]+(\w+$)/, "$10$3"));
        ...
        sortStyles: function(a) {
            for (var b = ["border", "border-bottom", "font-size", "background"],
                ...
                h = 0;
                h < d.length;
                h++) -1 !== n.indexOf(b, d[h].toLowerCase()) ? f.push(d[h]) : e.push(d[h]);
            f.sort(function(a, c) {
                var d =
                        n.indexOf(b, a.toLowerCase()),
        ...
        inliner: {
            ...
            filter: function(a) {
                var b = CKEDITOR.plugins.pastefromword.styles.inliner.filtered, c = n.array.indexOf, d = {}, f;
            ...
            inline: function(a) {
                ...
                CKEDITOR.tools.array.forEach(c,
                    function(a) {
                        ...
                        var c, g, r;
                        for (r = 0; r < a.count(); r++)
                            c = a.getItem(r), g = CKEDITOR.tools.parseCssText(c.getAttribute("style")), g =
                                CKEDITOR.tools.extend({}, g, b), c.setAttribute("style",
    ...
    CKEDITOR.plugins.pastefromword.lists = {
        ...
        removeSymbolText: function(a) {
            ...
            a.forEach(function(d) {
                    !b &&
                        ...
                        (d.value = d.value.replace(c, ""), d.parent.getHtml().match(/^(\s|&nbsp;)*$/) &&
        ...
        setListSymbol: function(a, b, c) {
            ...
            if ("ol" == a.name) {
                ...
                f = { "·": "disc", o: "circle", "§": "square" }, !d["list-style-type"] &&
                    f[b] &&
                    (d["list-style-type"] = f[b]);
        ...
        setListStart: function(a) {
            ...
            case "upper-alpha":
                ...
                break;
            case "decimal":
                a.attributes.start = parseInt(g.getSubsectionSymbol(b[c]),
                        10) -
                    c ||
                    1;
            }
            ...
            toNumber: function(a, b) {
                function c(a) {
                    ...
                    for (var b = 1, c = 1; 0 < a.length; c *= 26)
                        b += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) * c, a =
        ...
        createLists: function(a) {
            ...
            for (a = 0; a < e.length; a++) {
                ...
                for (d = 0; d < h.length; d++) {
                    ...
                    for (c = b.attributes["cke-list-level"]; c > l.length;) {
                        ...
                        0 < n.length
                            ? n[n.length - 1].add(p)
                            : (n =
                                new CKEDITOR.htmlParser.element("li", { style: "list-style-type:none" }), n.add(p), k
                                .add(n));
                        l.push(p);
                        m.push(p);
                        k = p;
                        c == l.length &&
                            g.setListSymbol(p, b.attributes["cke-symbol"], c);
                    }
                    for (; c < l.length;)
                        l.pop(), k =
                ...
                l[0].children.length &&
                (d = l[0].children[0].attributes["cke-symbol"], !d &&
                    1 < l[0].children.length &&
                    (d = l[0].children[1].attributes["cke-symbol"]), d && g.setListSymbol(l[0], d));
        ...
        cleanup: function(a) {
            var b = [
                    "cke-list-level", "cke-symbol",
                    "cke-list-id", "cke-indentation", "cke-dissolved"
                ],
                c,
                d;
        ...
        dissolveList: function(a) {
            ...
            var d = function(a) { return function(b) { return b.name == a } },
                f = function(a) { return d("ul")(a) || d("ol")(a) },
                e = CKEDITOR.tools.array,
                g = [],
                l,
                r;
            a.forEach(function(a) { g.push(a) }, CKEDITOR.NODE_ELEMENT, !1);
            l = e.filter(g, d("li"));
            var m = e.filter(g, f);
            e.forEach(m,
                function(a) {
        ...
        chopDiscontinuousLists: function(a, b) {
            for (var c = {}, d = [[]], f, e = 0; e < a.length; e++) {
                var h =
                        c[a[e].attributes["cke-list-level"]],
                    l = this.getListItemInfo(a[e]),
                    k,
                    m;
                h
                    ? (m = h.type.match(/alpha/) && 7 == h.index ? "alpha" : m, m =
                        "o" == a[e].attributes["cke-symbol"] && 14 == h.index ? "alpha" : m, k =
                        g.getSymbolInfo(a[e].attributes["cke-symbol"], m), l =
                        this.getListItemInfo(a[e]), (h.type != k.type ||
        ...
        getListItemInfo: function(a) {
            ...
            var b = n.parseCssText(a.attributes.style)["mso-list"], c = { id: "0", level: "1" };
    ...
    CKEDITOR.plugins.pastefromword.heuristics = {
        ...
        isDegenerateListItem: function(a,
            b) {
        ...
        assignListLevels: function(a, b) {
            if (!b.attributes || void 0 === b.attributes["cke-list-level"]) {
                ...
                var k = h(c, function(a, b) { return 0 === b ? 0 : a - c[b - 1] }),
                    n = this.guessIndentationStep(e.filter(c, function(a) { return 0 !== a })),
                    f = h(c, function(a) { return Math.round(a / n) });
                -1 !== e.indexOf(f, 0) && (f = h(f, function(a) { return a + 1 }));
                e.forEach(d, function(a, b) { a.attributes["cke-list-level"] = f[b] });
    ...
    CKEDITOR.config.pasteFromWord_heuristicsEdgeList =
        !0;
})();
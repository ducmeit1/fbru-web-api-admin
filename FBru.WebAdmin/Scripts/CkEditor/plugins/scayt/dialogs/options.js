                                    ...
                                    children: [
                                        {
                                            ...
                                            onLoad: function() {
                                                ...
                                                b.isLicensed() ||
                                                (a.css(h, { cursor: "not-allowed" }), a.css(f,
                                                    { cursor: "not-allowed" }));
                                            },
                                            onClick: function() {
                                            ...
                                            onClick: function() {
                                                var b = this.getDialog(),
                                                    ...
                                                    e = f.getValue();
                                                a.isLicensed() &&
                                                (a.disconnectFromUserDictionary({}), f.setValue(""),
                                                    h.toggleDictionaryState.call(b, "initialState"), c.fire(
                                                ...
                                                a.isLicensed() &&
                                                    a.removeUserDictionary(e,
                                                        function(a) {
                                                            f.setValue("");
                                                            a.error ||
                                                                h.toggleDictionaryState.call(b,
                                                                    "initialState");
                                                            a.dialog = b;
                                                            a.command = "remove";
                                                            a.name = e;
                                                    ...
                                                    children: [
                                                        {
                                                            ...
                                                            onClick: function() {
                                                                var b = this.getDialog(),
                                                                    ...
                                                                    f = b.getContentElement("dictionaries",
                                                                        "addWordField"),
                                                                    e = f.getValue(),
                                    ...
                                    children: [
                                        {
                                            ...
                                            onClick: function(b) {
                                                ...
                                                h.hasClass(b.target, "cke_scaytItemList_remove") &&
                                                    !this.isBlocked() &&
                                                    (this.block(), a.deleteWordFromUserDictionary(e,
                                                        function(a) {
        ...
        c.on("scaytUserDictionaryAction",
            function(b) {
                var a = SCAYT.prototype.UILib,
                    ...
                    d;
                void 0 === b.data.error
                    ? (d = e.getLocal("message_success_" + b.data.command + "Dic"), d =
                        d.replace("%s", b.data.name), f.setText(d), a.css(f.$,
                        { color: "blue" }))
                    : ("" === b.data.name
                            ? f.setText(e.getLocal("message_info_emptyDic"))
                            : (d = e.getLocal("message_error_" + b.data.command + "Dic"), d =
                                d.replace("%s", b.data.name), f.setText(d)), a.css(f.$, { color: "red" }),
        ...
        c.on("scaytUserDictionaryActionError",
            function(b) {
                ...
                "" === b.data.name
                    ...
                    : (g = e.getLocal("message_error_" + b.data.command + "Dic"), g =
                        g.replace("%s", b.data.name), d.setText(g));
                a.css(d.$, { color: "red" });
                null != e.getUserDictionaryName() && "" != e.getUserDictionaryName()
                    ? c.getContentElement("dictionaries", "dictionaryName").setValue(e.getUserDictionaryName())
                    : c.getContentElement("dictionaries", "dictionaryName").setValue("");
        ...
        var g = {
            ...
            buildRadioInputs: function(b, a, d) {
                var f = new CKEDITOR.dom.element("div"),
                    ...
                    g = CKEDITOR.dom.element.createFromHtml('\x3cinput id\x3d"' +
                        e +
                ...
                g.on("click", function(a) { p.newLang = a.sender.getValue() });
                k.appendText(b);
            ...
            renderLangList: function(b) {
                ...
                for (l in e)
                    k++, m = l in
                        f.ltr ||
                        l in f.rtl, this.buildRadioInputs(e[l], l, m).appendTo(k <= g ? a : b);
            },
            ...
            getUserDictionary: function() {
                var b = this;
                c.scayt.getUserDictionary("", function(a) { a.error || g.renderItemList.call(b, a.wordlist) });
            },
            renderItemList: function(b) {
                for (var a =
                             this.getContentElement("dictionaries", "itemList"),
                    c = 0;
                    c < b.length;
                    c++) a.addChild(b[c]);
            },
...
CKEDITOR.tools.extend(CKEDITOR.ui.dialog,
    {
        scaytItemList: function(c, d, k) {
            if (arguments.length) {
                var n = this;
                c.on("load", function() { n.getElement().on("click", function(c) {}) });
...
(function() {
    commonBuilder = { build: function(c, d, k) { return new CKEDITOR.ui.dialog[d.type](c, d, k) } };

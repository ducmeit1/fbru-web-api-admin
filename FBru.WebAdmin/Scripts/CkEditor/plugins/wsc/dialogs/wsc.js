...
(function() {
    ...
    var J = function(b) {
        ...
        K = function(b) {
            var c, d, e;
            for (e in b)
                c = a.dialog.getContentElement(a.dialog._.currentTabId, e), c || (c = b[e].instance), c.setLabel &&
                    (d = b[e].localizationID || e, c.setLabel(a.LocalizationComing[d] + ":"));
        },
        t,
        A;
    ...
    a.sendData = function(b) {
        ...
        var h = function(h) {
            ...
            h.data.getTarget().is("a") &&
                c !== a.previousTab &&
                (a.previousTab = c, d = b._.contents[c].Content, e =
    ...
    a.buildOptionLang =
        function(b, c) {
            var d = document.getElementById("wscLang" + c), e = document.createDocumentFragment(), f, h, k = [];
            if (0 === d.options.length) {
                for (f in b) k.push([f, b[f]]);
                k.sort();
                for (var p = 0; p < k.length; p++)
                    f = document.createElement("option"), f.setAttribute("value", k[p][1]), h =
                        document.createTextNode(k[p][0]), f.appendChild(h), e.appendChild(f);
                d.appendChild(e);
            }
    ...
    var B = function(a) {
            var c = document, d = a.target || c.body, e = a.id || "overlayBlock", f = a.opacity || "0.9";
            a = a.background || "#f1f1f1";
            var h = c.getElementById(e), k = h || c.createElement("div");
            k.style.cssText =
        ...
        M = function(b) {
            ...
            "no_any_suggestions" == b
                ? (b = "No suggestions", c =
                    ...
                    a.LocalizationButton.ChangeAll.instance, c.disable(), d("ChangeTo_button"), d("ChangeAll"))
    ...
    CKEDITOR.dialog.add("checkspell",
        function(b) {
            function c(a) {
                ...
                a._.moved ||
                (r = isNaN(c) && isNaN(e) ? 0 : 1, isNaN(c) && (c = (m.width - n.width) / 2), 0 > c && (c = 0), c >
                        m.width -
                        n.width &&
                        (c = m.width - n.width), isNaN(e) && (e = (m.height - n.height) / 2), 0 > e && (e = 0),
                    e > m.height - n.height && (e = m.height - n.height), a.move(c, e, r));
            }
            ...
            function d() {
                ...
                (function(a) {
                    ...
                    a.DataStorage = {
                        getData: function(a) { return d.get(a) },
                        setData: function(a, b) { d.set(a, b) },
                        deleteData: function(a) { d.del(a) },
                                ...
                                (b.wsc.isSsrvSame = function() {
                                    ...
                                    window.SCAYT &&
                                        ...
                                        (f = SCAYT.CKSCAYT.prototype.basePath, f.split("//"), g =
                                            f.split("//")[1].split("/")[0], p = f.split(g + "/")[1].replace(
                                                "/lf/scayt3/ckscayt/",
                                                "") +
                                            "/script/ssrv.cgi");
                                    !d ||
    ...
    CKEDITOR.dialog.add("options",
        function(b) {
            ...
            b = function(a) {
                ...
                "delete" != h &&
                (a = "", "" !== t.getValue() && (a = t.getValue()), g.cookie.set("udn",
                    a));

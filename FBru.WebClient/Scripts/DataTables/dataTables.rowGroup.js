 ...
 */
    ...
    DataTable.Api.register("rowGroup()",
        function() {
            return this;
        });

    DataTable.Api.register("rowGroup().disable()",
        function() {
    ...
    DataTable.Api.register("rowGroup().dataSrc()",
        function(val) {
            if (val === undefined) {

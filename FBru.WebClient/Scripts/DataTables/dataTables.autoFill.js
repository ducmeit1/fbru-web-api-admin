    ...
    $.extend(AutoFill.prototype,
        {
            ...
            _focusListener: function() {
                ...
                if (focus === "focus") {
                    ...
                    $(dt.table().body()).on("click" + namespace,
                        "td, th",
                        function(e) {
                            that._attach(this);
                        });

                    $(document.body).on("click" + namespace,
                        function(e) {
            ...
            _mouseup: function(e) {
                ...
                for (var rowIdx = 0; rowIdx < rows.length; rowIdx++) {
                    selected.push(
                        $.map(columns,
                            function(column) {
                                var cell = dt.cell(":eq(" + rows[rowIdx] + ")",
                                    column + ":visible",
                                    { page: "current" });
                                var data = cell.data();
...
// Doesn't do anything - Not documented
    Api.register("autoFill()",
        function() {
            return this;
        });

    Api.register("autoFill().enabled()",
        function() {
...
// events so we can automatically initialise
    $(document).on("preInit.dt.autofill",

    ...
    $.extend(RowReorder.prototype,
        {
            ...
            _constructor: function() {
                ...
                $(dt.table().container()).on("mousedown.rowReorder touchstart.rowReorder",
                    this.c.selector,
                    function(e) {
                        if (! that.c.enabled) {
                            return;
            ...
            _mouseDown: function(e, target) {
                ...
                $(document)
                    .on("mouseup.rowReorder touchend.rowReorder",
                        function(e) {
                            that._mouseUp(e);
                        })
...
// Doesn't do anything - work around for a bug in DT... Not documented
    Api.register("rowReorder()",
        function() {
            return this;
        });

    Api.register("rowReorder.enable()",
        function(toggle) {
            if (toggle === undefined) {
                toggle = true;
            }
    ...
    Api.register("rowReorder.disable()",
        function() {
            return this.iterator("table",
                function(ctx) {
                    if (ctx.rowreorder) {

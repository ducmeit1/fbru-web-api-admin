    ...
    $.extend(FixedHeader.prototype,
        {
            ...
            _constructor: function() {
                ...
                dt.on("column-reorder.dt.dtfc column-visibility.dt.dtfc draw.dt.dtfc column-sizing.dt.dtfc",
                    function() {
                        that.update();
                    });
            ...
            _scroll: function(forceChange) {
                ...
                if (this.c.footer && this.dom.tfoot.length) {
                    if (! position.visible ||
                        ...
                        footerMode = "in-place";
                    } else if (position.windowHeight + windowTop >
...
// DataTables API methods
    ...
    DataTable.Api.register("fixedHeader.enable()",
        function(flag) {
            return this.iterator("table",
                function(ctx) {
                    var fh = ctx._fixedHeader;
    ...
    DataTable.Api.register("fixedHeader.disable()",
        function() {
            return this.iterator("table",
                function(ctx) {
                    var fh = ctx._fixedHeader;
    ...
    $.each(["header", "footer"],
        function(i, el) {
            DataTable.Api.register("fixedHeader." + el + "Offset()",
                function(offset) {
